...
# Extraer países que contengan la palabra "land"
data_countries = [
    'Argentina', 'Australia', 'Bolivia', 'Colombia', 'Tierra del Fuego', 'Finlandia', 'Groenlandia'
]
land = [country for country in data_countries if "land" in country.lower()]
print("Países con 'land':", land)
